...
function Master(module, opts) {
  ...
  if (opts.heartbeat_timeout == null) {
    opts.heartbeat_timeout = 1000;
  }

  if (opts.startup_timeout == null) {
    opts.startup_timeout = 10000;
  }
  ...
  if (opts.kill_wait_timeout == null) {
    opts.kill_wait_timeout = 5000;
  }
